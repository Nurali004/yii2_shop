        ...
        <div class="container-fluid fixed-top">
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        <small class="me-3"><i class="fas fa-phone me-2 text-secondary"></i> <a href="#" class="text-white"><?= $settings->phone_number   ?></a></small>
                        <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#" class="text-white"><?= $settings->email ?></a></small>
                    </div>
                    <div class="top-link pe-2">
                        <a href="#" class="text-white"><small class="text-white mx-2"><?= $settings->site_name ?></small>/</a>
                        <a href="#" class="text-white"><small class="text-white mx-2"><?= $settings->telegram_url ?></small>/</a>
                        <a href="#" class="text-white"><small class="text-white mx-2"><?= $settings->instagram_url ?></small>/</a>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="/" class="navbar-brand"><h1 class="text-primary display-6"><img src="/<?= $settings->logo_img ?>" width="100" height="90px"></h1></a>
                   ...
                   <div class="row g-4">
                       ...
                       <div class="col-lg-3">
                           <div class="d-flex justify-content-end pt-3">
                               <a class="btn  btn-outline-secondary me-2 btn-md-square rounded-circle" href="<?= $settings->telegram_url ?>"><i class="fab fa-telegram"></i></a>
                               <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle" href="<?= $settings->facebook_url ?>"><i class="fab fa-facebook-f"></i></a>
                               <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle" href="<?= $settings->youtube_url ?>"><i class="fab fa-youtube"></i></a>
                               <a class="btn btn-outline-secondary btn-md-square rounded-circle" href="<?= $settings->instagram_url ?>"><i class="fab fa-instagram"></i></a>
                           </div>
                       </div>
                   </div>
               </div>
